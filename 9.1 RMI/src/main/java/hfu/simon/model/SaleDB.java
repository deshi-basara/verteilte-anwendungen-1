 ...
 */
public class SaleDB extends UnicastRemoteObject implements SaleDBInterface {
    ...
    public SaleDB(int ticketsAvailable, String dbHost, int dbPort, String dbName,
                  String dbUser, String dbPass, boolean useHeroku) throws RemoteException {
        ...
        // set dataSource
        dataSource.setDataSourceName("Local Database");
